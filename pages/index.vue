  ...
  <div class="container d-md-flex align-items-stretch ">
    <div class="pt-2" style="background-color: ">
      ...
      <p>Pianos are my life, and no day is complete without playing.
        ...
        Basic tuning services start at just $110. My primary service areas are Davis and Weber counties in Utah. Service outside of Davis and Weber counties will incur an additional fee for travel. 
    ...
    return {
      ...
      meta: [
        // hid is used as unique identifier. Do not use `vmid` for it as it will not work
        {
          hid: 'top',
          name: 'description',
          content: 'Dusty Rose Piano - Piano Tuning Service in Northern Utah'
        }
      ]
    }
  },
